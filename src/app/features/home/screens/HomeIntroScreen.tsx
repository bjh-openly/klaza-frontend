          ...
          <>
            ...
            >
              <View style={styles.heroOverlay}>
                ...
                <Text style={styles.heroSubtitle}>Catch today’s lounge posts in one glance.</Text>
              </View>
            </ImageBackground>
            <View style={styles.sectionTitle}>
              ...
              <Text style={styles.sectionDescription}>See the newest KLAZA posts first.</Text>
            </View>
          </>
        }
      />
